quiz_data = [
    [{
        "question": "What data type is '2.54'?",
    ...
    },
    {
        ...
        "choices": ["_2", "money$", "3", "variable name"],
        "answer": "_2"
    },
    {
        "question": "Which of the following is a valid variable name?",
        "choices": ["int", "True", "name", "if"],
        "answer": "name"
    },
    {
        "question": "Which of the following is a valid variable name?",
        "choices": ["break", "false", "and", "in"],
        "answer": "false"
    },
    {
        "question": "Which of the following is an INVALID operator?",
        "choices": ["+", "/", "**", "!"],
        "answer": "!"
    },
    {
        "question": "What is the evaluation of 6**2?",
        "choices": ["error", "36", "3", "8"],
        "answer": "36"
    },
    {
        "question": "Which in-built python method is used to take a user input?",
        "choices": ["in()", "inputs()", "input()", "user()"],
        "answer": "input()"
    },
    {
        "question": "Which of the following is a valid variable assignment?",
        "choices": ["in  = input(“Enter a number: ”)", "number == 3", "amount = $25", "sum= 3 + 5"],
        "answer": "sum= 3 + 5"
    }
    ],
    [
